    ...
    return (
        ...
        <div className="py-100">
            ...
            <Container>
                ...
                <p data-aos="fade-right" className='text-[#181818] text-[24px] italic w-168.5 leading-[180%] pb-7.5 '>"I recently rented a car from Speedy and I was blown away by the level of service I received. The booking process was quick and easy, and the staff were friendly and helpful when I arrived to pick up my rental car”</p>
